...
const layoutAnimationDemo = () => {
  ...
  return (
    <div className="p-5 lg:p-10 max-w-[1920px] mx-auto">
      <div className="flex flex-wrap sm:grid sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-5 lg:mb-10">
        {groups.map((group) => (
          <button
            className={`py-2.5 px-4 sm:px-0 col-span-1 border border-sky-900 rounded text-xs lg:text-base font-semibold ${
              selectedGroup === group ? "bg-sky-900 text-white" : "text-sky-900"
            }`}
            key={group}
